 ...
 * *******************************************************************************
 */
function HeaderController($log, $scope, $rootScope, $route, $location, $window, institutionService)
{
...
HeaderController.$inject=["$log","$scope","$rootScope", "$route", "$location","$window", "institutionService"];
